...
export const contact: ContactInfo = {
  ...
  github: 'https://github.com/RudyGamarra',
};
...
export const projects: ProjectItem[] = [
  {
    ...
    thumbnail: '/assets/projects/GameJam/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/HUq7uPs4kXA' },
      { type: 'video', src: 'https://youtu.be/aNbAqfccavM' },
      { type: 'image', src: '/assets/projects/GameJam/img1.png' },
      { type: 'image', src: '/assets/projects/GameJam/img2.png' },
      { type: 'image', src: '/assets/projects/GameJam/img3.png' },
      { type: 'image', src: '/assets/projects/GameJam/img4.png' },
      { type: 'image', src: '/assets/projects/GameJam/img5.png' },
      { type: 'image', src: '/assets/projects/GameJam/img6.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/Caral Pututus/img 1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/66kOun_O4L8' },
      { type: 'image', src: '/assets/projects/Caral Pututus/img 1.png' },
      { type: 'image', src: '/assets/projects/Caral Pututus/img2.jpg' },
      { type: 'image', src: '/assets/projects/Caral Pututus/img3.jpg' },
      { type: 'image', src: '/assets/projects/Caral Pututus/img4.jpg' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/Demo tecnica Caral/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/euE8oVjLfcc' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img1.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img2.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img3.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img4.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img5.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img6.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img7.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img8.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img9.png' },
      { type: 'image', src: '/assets/projects/Demo tecnica Caral/img10.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/ARObstetra/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/OOts5CddUxg' },
      { type: 'image', src: '/assets/projects/ARObstetra/img1.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img2.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img3.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img4.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img5.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img6.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img7.png' },
      { type: 'image', src: '/assets/projects/ARObstetra/img8.png' },
    ]
  },
  {
    name: 'Veterinaria',
    ...
    technologies: ['Unity', 'C#', 'Meta quest', 'VR',],
    thumbnail: '/assets/projects/Veterinaria/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/5qYEDPaL1Bk' },
      { type: 'image', src: '/assets/projects/Veterinaria/img1.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img2.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img3.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img4.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img5.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img6.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img7.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img8.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img9.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img10.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img11.png' },
      { type: 'image', src: '/assets/projects/Veterinaria/img12.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/visulaizador dep/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/RRNnvHxroAM' },
      { type: 'image', src: '/assets/projects/visulaizador dep/img1.png' },
      { type: 'image', src: '/assets/projects/visulaizador dep/img2.png' },
      { type: 'image', src: '/assets/projects/visulaizador dep/img3.png' },
      { type: 'image', src: '/assets/projects/visulaizador dep/img4.png' },
      { type: 'image', src: '/assets/projects/visulaizador dep/img5.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/CAREFichas/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/NwUr1uyS6Lk' },
      { type: 'image', src: '/assets/projects/CAREFichas/img1.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img2.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img3.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img4.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img5.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img6.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img7.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img8.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img9.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img10.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img11.png' },
      { type: 'image', src: '/assets/projects/CAREFichas/img12.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/AR_MarketingDemo/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/JGierWAu_U0' },
      { type: 'image', src: '/assets/projects/AR_MarketingDemo/img1.png' },
      { type: 'image', src: '/assets/projects/AR_MarketingDemo/img2.png' },
      { type: 'image', src: '/assets/projects/AR_MarketingDemo/img3.png' },
      { type: 'image', src: '/assets/projects/AR_MarketingDemo/img4.png' },
      { type: 'image', src: '/assets/projects/AR_MarketingDemo/img5.png' },
    ]
  },
  {
    name: 'Iluminarias',
    ...
    thumbnail: '/assets/projects/Luminarias/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/rT4Q0IvbcBE' },
      { type: 'video', src: 'https://youtu.be/4UPzZW6CZpM' },
      { type: 'image', src: '/assets/projects/Luminarias/img1.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img2.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img3.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img4.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img5.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img6.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img7.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img8.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img9.png' },
      { type: 'image', src: '/assets/projects/Luminarias/img10.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/Enel/img1.png',
    media: [
      ...
      { type: 'image', src: '/assets/projects/Enel/img1.png' },
      { type: 'image', src: '/assets/projects/Enel/img2.png' },
      { type: 'image', src: '/assets/projects/Enel/img3.png' },
      { type: 'image', src: '/assets/projects/Enel/img4.png' },
      { type: 'image', src: '/assets/projects/Enel/img5.png' },
      { type: 'image', src: '/assets/projects/Enel/img6.png' },
      { type: 'image', src: '/assets/projects/Enel/img7.png' },
      { type: 'image', src: '/assets/projects/Enel/img8.png' },
      { type: 'image', src: '/assets/projects/Enel/img9.png' },
    ]
  },
  {
    ...
    thumbnail: '/assets/projects/hackaton2019/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/6k6KqCOUab0' },
      { type: 'image', src: '/assets/projects/hackaton2019/img1.png' },
      { type: 'image', src: '/assets/projects/hackaton2019/img2.png' },
      { type: 'image', src: '/assets/projects/hackaton2019/img3.png' },
      { type: 'image', src: '/assets/projects/hackaton2019/img4.png' },
      { type: 'image', src: '/assets/projects/hackaton2019/img5.png' },
    ]
  },
  {
    ...
    technologies: ['Unity', 'C#','WebGL'],
    thumbnail: '/assets/projects/Simulador Academico Certus/img1.png',
    media: [
      { type: 'video', src: 'https://youtu.be/79AChp89Lqw' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img1.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img2.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img3.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img4.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img5.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img6.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img7.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img8.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img9.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img10.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img11.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img12.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img13.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img14.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img15.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img16.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img17.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img18.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img19.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img20.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img21.png' },
      { type: 'image', src: '/assets/projects/Simulador Academico Certus/img22.png' },
    ]
  }
];
