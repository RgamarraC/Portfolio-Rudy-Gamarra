...
import { CardEducationItem } from './styled';
    ...
    <Section number="05" title={title} id={id}>
      <div className="space-y-4">
        {educationHistory.map((edu, index) => (
          <CardEducationItem key={index} className="group relative grid pb-1 transition-all sm:grid-cols-5 sm:gap-5 md:gap-2 lg:group-hover/list:opacity-50">
            ...
            <header className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-1">{edu.period}</header>
